...
public class HouseCriteria implements Serializable {
    ...
    private StringFilter avatarLink;
    ...
    public StringFilter getAvatarLink() {
        return avatarLink;
    }

    public void setAvatarLink(StringFilter avatarLink) {
    ...
    public String toString() {
        return "HouseCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (avatarLink != null ? "avatarLink=" + avatarLink + ", " : "") +
