...
public class UserFinancialCriteria implements Serializable {
    ...
    private FloatFilter savingMoney;
    ...
    public FloatFilter getSavingMoney() {
        return savingMoney;
    }

    public void setSavingMoney(FloatFilter savingMoney) {
    ...
    public String toString() {
        return "UserFinancialCriteria{" +
                ...
                (savingMoney != null ? "savingMoney=" + savingMoney + ", " : "") +
