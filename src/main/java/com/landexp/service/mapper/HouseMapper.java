 ...
 */
@Mapper(componentModel = "spring", uses = {DistrictMapper.class, CityMapper.class, StreetMapper.class, LandProjectMapper.class, UserMapper.class, HousePhotoMapper.class})
