                  ...
                  <div className="listview-right">
                    <div className="page-info">
                      <p className="text-center">
                        Lựa chọn Bất động sản phù hợp với nhu cầu của bạn hoặc liên hệ với chúng tôi để được tư vấn mua / thuê Bất động sản
                        tốt nhất
                      </p>
                    ...
                    <div className="description" id="description">
                      ...
                      <div className="content">
                        <p>
                          The crafting and the designing of the project is built with exceptional and well planned amenities to showcase a
                          world within the four walls. The quality work and dedication in intending this concrete chic is an idea of lavish
                          living. The well planned structures …
                        </p>
                      </div>
                      <p>
