          ...
          this.props.data.map(item => (
            <div className="post-item">
              <div className="item-thumbnail">
                ...
                {
                  item.sell ?
                    <div className="type sell">{ item.action }</div>
                    :
                    <div className="type hire">{ item.action }</div>
                }
              </div>
              <div className="item-info">
                ...
                <div className="button-group">
                  ...
                  <span className="favorite">
                    <a><FontAwesomeIcon icon="heart" /></a> {' '}
                  </span>
                  <span className="contact contact-distance"><a href="#">Liên hệ</a></span>
                </div>
              </div>
            </div>
          ))}
