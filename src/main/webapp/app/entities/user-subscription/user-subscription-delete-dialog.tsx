...
export interface IUserSubscriptionDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export default connect(mapStateToProps, mapDispatchToProps)(UserSubscriptionDeleteDialog);
