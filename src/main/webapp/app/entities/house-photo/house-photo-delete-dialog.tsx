...
export interface IHousePhotoDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export default connect(mapStateToProps, mapDispatchToProps)(HousePhotoDeleteDialog);
