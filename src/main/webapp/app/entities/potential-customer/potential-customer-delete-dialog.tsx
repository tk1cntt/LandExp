...
export interface IPotentialCustomerDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export default connect(mapStateToProps, mapDispatchToProps)(PotentialCustomerDeleteDialog);
