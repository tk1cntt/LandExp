...
import { getEntity, deleteEntity } from './user-tracking.reducer';

export interface IUserTrackingDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}

export class UserTrackingDeleteDialog extends React.Component<IUserTrackingDeleteDialogProps> {
  componentDidMount() {
...
export default connect(mapStateToProps, mapDispatchToProps)(UserTrackingDeleteDialog);
