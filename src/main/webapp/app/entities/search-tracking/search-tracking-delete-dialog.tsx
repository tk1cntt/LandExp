...
import { getEntity, deleteEntity } from './search-tracking.reducer';

export interface ISearchTrackingDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}

export class SearchTrackingDeleteDialog extends React.Component<ISearchTrackingDeleteDialogProps> {
  componentDidMount() {
...
export default connect(mapStateToProps, mapDispatchToProps)(SearchTrackingDeleteDialog);
