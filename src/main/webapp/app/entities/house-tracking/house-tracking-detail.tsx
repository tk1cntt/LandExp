  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="landexpApp.houseTracking.detail.title">HouseTracking</Translate> [<b>{houseTrackingEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>
              <TextFormat value={houseTrackingEntity.createAt} type="date" format={APP_LOCAL_DATE_FORMAT} />
            </dd>
            <dt>
              <Translate contentKey="landexpApp.houseTracking.house">House</Translate>
            </dt>
            <dd>{houseTrackingEntity.houseId ? houseTrackingEntity.houseId : ''}</dd>
            <dt>
              <Translate contentKey="landexpApp.houseTracking.user">User</Translate>
            </dt>
            <dd>{houseTrackingEntity.userLogin ? houseTrackingEntity.userLogin : ''}</dd>
          </dl>
          ...
          <Button tag={Link} to={`/entity/house-tracking/${houseTrackingEntity.id}/edit`} replace color="primary">
...
const mapStateToProps = ({ houseTracking }: IRootState) => ({
  houseTrackingEntity: houseTracking.entity
});
