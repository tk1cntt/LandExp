...
export interface IUserFinancialDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export default connect(mapStateToProps, mapDispatchToProps)(UserFinancialDeleteDialog);
