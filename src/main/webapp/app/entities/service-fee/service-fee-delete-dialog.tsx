...
export interface IServiceFeeDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export default connect(mapStateToProps, mapDispatchToProps)(ServiceFeeDeleteDialog);
