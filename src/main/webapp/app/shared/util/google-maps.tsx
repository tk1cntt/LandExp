...
const MyMapComponent: React.StatelessComponent<{
  ...
  <GoogleMap defaultZoom={16} defaultCenter={{ lat: 21.0286669, lng: 105.8521484 }}>
    {props.isMarkerShown && (
      <Marker position={{ lat: 21.0286669, lng: 105.8521484 }} draggable onDragEnd={(e) => {
        axios.get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${e.latLng.lat()},${e.latLng.lng()}&sensor=false&key=AIzaSyCYcnnPJ3J-v8nbiyGbp4APnQANcmQeIwc`)
