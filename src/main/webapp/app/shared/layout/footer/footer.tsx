          ...
          <div className="container">
      			<div className="row">
      				<div className="col-md-4">
      					...
      					<p>Địa chỉ: Số 02, ngách 158/51 Nguyễn Khánh Toàn,<br /> P.Quan Hoa, Q.Cầu Giấy, TP.Hà Nội</p>
      				...
      				<div className="col-md-2">
      					...
      					<ul>
      						...
      						<li><a href="#">Dành cho người mua</a></li>
      				...
      				<div className="col-md-4">
      					...
      					<p className="link-app">
      						<a href="#"><img src="static/images/icon/IOS.png" alt="" /></a>
      						<a href="#"><img src="static/images/icon/ANDROID.png" alt="" /></a>
      					</p>
